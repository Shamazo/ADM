...
enum class range_log_op {
  ...
  MEMMOVE_PROPAGATE,
  MEMMOVE_GET_PROPAGATED,
  MEMMOVE_WAITING_FOR_TRANSFER,
  MEMMOVE_CATCHER,
  IOURING_SUBMIT,
  IOURING_FLUSH,
  ...
  GROUTER_CONS_FIRE,
  GROUTER_CONSUME,
  GROUTER_WAITING_FOR_TASK,
  GROUTER_CLOSE,
  GROUTER_INIT_CONS,
  GROUTER_ACQUIRE_BUFF,
  QUERY_EXECUTE,
...
enum class counter_type {
  ...
  GROUTER_CONS_THROUGHPUT,
  TP_ADAPTIVE_THROUGHPUT
};
