...
PreparedStatement prepare21_adaptive(QueryArgs args) {
...
PreparedStatement prepare21_adaptive_shared_ht(QueryArgs args) {
  args.morph->setQueryName(query);
  ...
  // Lambda to process joins and groupby - similar to Q3.4 implementation
