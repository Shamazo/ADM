...
constexpr auto query = "ssb100_Q4_2_pushdown";

constexpr int filter_id = 4242;
...
PreparedStatement prepare42_pushdown(
  ...
  auto rel_part = morph.scan("part", {"p_partkey", "p_mfgr", "p_category"});

  auto scan_build_supp =
      morph.scan("supplier", {"s_suppkey", "s_region", "s_nation"})
